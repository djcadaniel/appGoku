...
export const Details = ({name, ki, maxKi, race, gender, description, image}: DetailsProps) => {
  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-full pb-12">
      ...
      <div className="row-start-2 lg:col-start-2 lg:row-start-1 lg:row-span-2 w-full h-[700px] flex justify-center lg:justify-end xl:justify-center items-center py-12 z-40 bg-green-300">
